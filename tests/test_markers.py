...
def test_an_invalid_expression_is_signalled_and_selects_nothing(barre):
    ...
    # v1 pose ses styles widget par widget : le champ doit porter le rouge du
    # theme, pas une propriete Qt.
    from gui_qt.styles import styles

    assert styles.LIGHT["danger"].lower() in barre.field.styleSheet().lower()
